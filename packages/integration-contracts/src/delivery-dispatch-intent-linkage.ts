...
export interface DeliveryDispatchIntentIntegrationWarning {
  code: string;
  message: string;
}

export interface DeliveryDispatchIntentLinkageShape<TResult = Record<string, unknown>> {
  linkage_id: string;
  ...
  linkage_boundary: {
    delivery_dispatch_intent_placeholder_only: true;
  ...
  warnings: DeliveryDispatchIntentIntegrationWarning[];
  linked_at: IsoDateTimeString;
}

export interface DeliveryDispatchIntentLinkageBuilder {
  ...
  }): DeliveryDispatchIntentLinkageShape<TResult>;
}

export const createDeliveryDispatchIntentLinkageBuilder = (): DeliveryDispatchIntentLinkageBuilder => {
  return {
    build<TResult = Record<string, unknown>>(input: {
      linkage_id: string;
      delivery_dispatch_intent_id: string;
