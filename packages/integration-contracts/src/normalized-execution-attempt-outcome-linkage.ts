...
export interface NormalizedExecutionAttemptOutcomeIntegrationWarning {
  code: string;
  message: string;
}

export interface NormalizedExecutionAttemptOutcomeLinkageShape<TResult = Record<string, unknown>> {
  linkage_id: string;
  ...
  warnings: NormalizedExecutionAttemptOutcomeIntegrationWarning[];
  linked_at: IsoDateTimeString;
}

export interface NormalizedExecutionAttemptOutcomeLinkageBuilder {
  ...
  }): NormalizedExecutionAttemptOutcomeLinkageShape<TResult>;
}

export const createNormalizedExecutionAttemptOutcomeLinkageBuilder =
  (): NormalizedExecutionAttemptOutcomeLinkageBuilder => {
    return {
      build<TResult = Record<string, unknown>>(input: {
        linkage_id: string;
        normalized_outcome_id: string;
