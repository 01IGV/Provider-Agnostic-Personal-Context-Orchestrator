...
export const runLocalJsonSingleCommand = ({ request_path, response_path, variation }) => {
  ...
  return {
    ...
    response_observation_summary_result: runnerResult.response_observation_summary_result,
    agent_readable_contract: runnerResult.agent_readable_contract,
    agent_response_status: runnerResult.agent_response_status,
    selected_source_item_count: runnerResult.selected_source_item_count,
    selected_source_refs: runnerResult.selected_source_refs,
    selected_scope_ids: runnerResult.selected_scope_ids,
    safe_agent_use_hints: runnerResult.safe_agent_use_hints,
    denied_agent_action_hints: runnerResult.denied_agent_action_hints,
